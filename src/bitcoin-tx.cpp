...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s healthcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  healthcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded healthcoin transaction") + "\n" +
              "  healthcoin-tx [options] -create [commands]   " + _("Create hex-encoded healthcoin transaction") + "\n" +
              "\n";
