...
#if defined(NDEBUG)
# error "Healthcoininin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Healthcoininin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("healthcoin-scriptch");
