...
"""Verify that starting healthcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start healthcoin with -h for help text")
        ...
        self.log.info("Start healthcoin with -version for version information")
