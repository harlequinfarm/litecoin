...
* healthcoin.conf: contains configuration settings for healthcoind or healthcoin-qt
* healthcoind.pid: stores the process id of healthcoind while running
...
* debug.log: contains debug information and general logging generated by healthcoind or healthcoin-qt
