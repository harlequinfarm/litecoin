...
LITECOIND=${LITECOIND:-$SRCDIR/healthcoind}
LITECOINCLI=${LITECOINCLI:-$SRCDIR/healthcoin-cli}
LITECOINTX=${LITECOINTX:-$SRCDIR/healthcoin-tx}
LITECOINQT=${LITECOINQT:-$SRCDIR/qt/healthcoin-qt}
